...
class AliceBlue:
    ...
    def __init__(self, username, password, access_token,app_id, master_contracts_to_download):
    ...
    @staticmethod
    def login_and_get_access_token(username, password, twoFA, api_secret,app_id,redirect_url='https://ant.aliceblueonline.com/plugin/callback'):
    ...
    def place_order(self, transaction_type, instrument, quantity, order_type,
        ...
        #print(self.__api_call_helper(helper, Requests.POST, None, order))    
